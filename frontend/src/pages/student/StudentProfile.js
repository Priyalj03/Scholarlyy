...
const StudentProfile = () => {
    ...
    const fields = password === '' ? { name, email, rollNum } : { name, email, password, rollNum };
    ...
    const deleteHandler = () => {
        try {
            dispatch(deleteUser(currentUser._id, "Student"));
            dispatch(authLogout());
            navigate('/');
        } catch (error) {
            console.error(error);
                    ...
                    <StyledPaper elevation={6}>
                        ...
                        <ProfileSection>
                            <ProfileHeader>
                                ...
                                <ProfileInfo>
                                    <ProfileName>{currentUser?.name || 'Student'}</ProfileName>
                            ...
                            {!isEditing ? (
                                <ProfileDetails>
                                    ...
                                    <DetailItem>
                                        <NumbersIcon sx={{ color: '#00E5FF', mr: 2 }} />
                                        <DetailContent>
                                            <DetailLabel>Roll Number</DetailLabel>
                                            <DetailValue>{currentUser?.rollNum || 'Not set'}</DetailValue>
                                        </DetailContent>
                                    </DetailItem>
                                    ...
                                    <DetailItem>
                                        ...
                                        <DetailContent>
                                            ...
                                            <DetailValue>{currentUser?.sclassName?.sclassName || 'Not assigned'}</DetailValue>
                                        </DetailContent>
                                    </DetailItem>
                                ...
                                <EditForm onSubmit={submitHandler}>
                                    ...
                                    <TextField
                                        ...
                                        required
                                        InputProps={{
                                            startAdornment: <NumbersIcon sx={{ color: '#00E5FF', mr: 1 }} />,
                                        }}
                                    />
