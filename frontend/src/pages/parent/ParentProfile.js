...
const ParentProfile = () => {
    ...
    const submitHandler = (event) => {
        ...
        dispatch(updateUser(fields, currentUser._id, "Parent"));
        setIsEditing(false);
        setSnackbar({
            open: true,
    ...
    const deleteHandler = () => {
        try {
            dispatch(deleteUser(currentUser._id, "Parent"));
            dispatch(authLogout());
            navigate('/');
        } catch (error) {
            console.error(error);
                    ...
                    <StyledPaper elevation={6}>
                        ...
                        <ProfileSection>
                            <ProfileHeader>
                                ...
                                <ProfileInfo>
                                    <ProfileName>{currentUser?.name || 'Parent'}</ProfileName>
                            ...
                            {!isEditing ? (
                                <ProfileDetails>
                                    ...
                                    <DetailItem>
                                        <ChildIcon sx={{ color: '#00E5FF', mr: 2 }} />
                                        <DetailContent>
                                            <DetailLabel>Student Name</DetailLabel>
                                            <DetailValue>{currentUser?.student?.name || 'Not assigned'}</DetailValue>
                                        </DetailContent>
                                    </DetailItem>
                                    ...
                                    <DetailItem>
                                        ...
                                        <DetailContent>
                                            <DetailLabel>Student Class</DetailLabel>
                                            <DetailValue>{currentUser?.student?.sclassName || 'Not assigned'}</DetailValue>
                                        </DetailContent>
                                    </DetailItem>
